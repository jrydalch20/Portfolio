...
<html>
	...
	<body>
		...
		<a class="btn btn-dark ms-5 mb-2 mt-2" href="PFHome.php" role="button">Back to Home</a>

		<div class="list-container bg-light w-100 p-3">
			<div class="container text-center w-50">
					...
					<ul class="list-group">
						<li class="list-group-item">
							<a href="programmingprojects2.php" class="link-info link-underline-opacity-25 link-offset-2">
								WebDev & Database ->
							</a>
						</li>
						<li class="list-group-item">
							<a href="financialprojects.php" class="link-info link-underline-opacity-25 link-offset-2">
								Financial ->
							</a>
						</li>
					</ul>
